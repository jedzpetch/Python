...
# Form implementation generated from reading ui file 'ui\addorder.ui'
#
...
class Ui_addorder(object):
    def setupUi(self, addorder):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ui\\../../image/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"background-color : rgb(255, 216, 215)")
    ...
    def adddata(self):
        ...
        menu = self.lineEdit_2.text()
        details = self.lineEdit_3.text()
        ...
        if (ID == '' or menu == '' or details == '' or price == ''):
            ...
            cursor = con.cursor()
            cursor.execute("INSERT INTO data (NO,title,details,price) VALUES (%s, %s, %s, %s)",
                           (ID, menu, details, price))
            con.commit()
